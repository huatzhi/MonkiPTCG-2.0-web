...
export const shareConfig = {
  defaultTitle: 'Team Monki - Professional Pokémon TCG Team',
  defaultDescription: 'Join our journey in competitive PTCG',
  platforms: [
    {
      name: 'Facebook',
      icon: (
...
// 分享功能工具函数
export const shareToPlatform = (platform, url, title) => {
  if (platform.isCopyAction) {
